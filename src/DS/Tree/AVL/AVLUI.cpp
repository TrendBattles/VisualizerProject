...
void AVLUI::updateInit(Vector2 rootPos) {
...
void AVLUI::updateOthers(Vector2 rootPos) {
...
///     UI RENDER     ///
/////////////////////////
bool AVLUI::exceedsTextboxInitRange() {
...
void AVLUI::renderInit(Vector2 rootPos) {
...
void AVLUI::renderOthers(Vector2 rootPos) {
...
///     FIELD INPUT PROCESS     ///
///////////////////////////////////
void AVLUI::handleInputFieldInit() {
...
void AVLUI::processInputFieldInit(RawInputEvent nextInput) {
    ButtonController* targetController = navbarMap[navPhase].getButtonController(operationPlaceholder);
    ShapeState targetBackground = targetController -> getButtonShape().getBackground();
    Vector2 rootPos = {FIELD_GAP_X + BUTTON_WIDTH, targetBackground.startPosition.y};
...
void AVLUI::processInputFieldOthers(RawInputEvent nextInput) {
    ButtonController* targetController = navbarMap[navPhase].getButtonController(operationPlaceholder);
    ShapeState targetBackground = targetController -> getButtonShape().getBackground();
    Vector2 rootPos = {FIELD_GAP_X + BUTTON_WIDTH, targetBackground.startPosition.y};
...
CommandPattern AVLUI::fieldInitListenerRequest(RawInputEvent nextInput) {
    ButtonController* targetController = navbarMap[navPhase].getButtonController(operationPlaceholder);
    ShapeState targetBackground = targetController -> getButtonShape().getBackground();
    Vector2 rootPos = {FIELD_GAP_X + BUTTON_WIDTH, targetBackground.startPosition.y};
...
CommandPattern AVLUI::fieldOthersListenerRequest(RawInputEvent nextInput) {
    ButtonController* targetController = navbarMap[navPhase].getButtonController(operationPlaceholder);
    ShapeState targetBackground = targetController -> getButtonShape().getBackground();
    Vector2 rootPos = {FIELD_GAP_X + BUTTON_WIDTH, targetBackground.startPosition.y};
